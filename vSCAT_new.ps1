...
Function fn_sddcscanner { 
  ...
  $jsonOutput = "/root/results/VCF_Scan_"+$global:SDDCmgr+"_"+$global:date
...
Function fn_ESXscanner { 
  Write-Host "Running ESX Host Scan:"
    ...
    $env:NO_COLOR=$true
  $jsonOutput = "/root/results/ESX_Scan_"+$global:date
  Write-Host "Saving results to: "$jsonOutput
...
Function fn_nsxscanner { 
  ...
  $jsonOutput = "/root/results/NSX_Scan_"+$global:NSXmgr+"_"+$global:date
  Write-Host "Saving results to: "$jsonOutput
