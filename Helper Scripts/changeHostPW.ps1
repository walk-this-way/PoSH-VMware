<#
Code pulled from this public repo: https://github.com/sammcgeown/Change-HostPasswords/blob/master/Change-HostPasswords.ps1

Tested in vsphere 7.0 lab Dec2023, confirmed works as intended.
